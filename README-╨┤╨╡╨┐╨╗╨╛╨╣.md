...
1. Купи stroniq.com (или .app) у регистратора (ps.kz, hoster.kz — от ~2000 ₸/год за .kz).
2. В Settings → Pages → Custom domain впиши stroniq.com.
...
1. search.google.com/search-console → Добавить ресурс → домен stroniq.com.
2. Подтверди владение (DNS-записью TXT — регистратор поможет).
3. Отправь sitemap: в меню «Файлы Sitemap» → https://stroniq.com/sitemap.xml
...
Захочешь app.stroniq.com вместо streamlit.app — это отдельная настройка
